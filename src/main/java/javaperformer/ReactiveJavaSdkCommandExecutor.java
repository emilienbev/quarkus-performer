...
import javaperformer.stream.FluxStreamer;
...
import static javaperformer.JavaSdkCommandExecutor.*;
...
import static javaperformer.search.SearchHelper.handleSearchQueryReactive;
import static javaperformer.search.SearchHelper.handleSearchReactive;
// [end]
...
public class ReactiveJavaSdkCommandExecutor extends SdkCommandExecutor {
    ...
    private Mono<Result> performOperationReactive(Command op, PerRun perRun) {
        return Mono.defer(() -> {
